...
heroImg: https://res.cloudinary.com/practicaldev/image/fetch/s--0sdgyFHo--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://thepracticaldev.s3.amazonaws.com/i/fmmsca2u3ssel70leqyt.png
...
- `watch`: _"function expects a function"_ itu istilahnya. Fungsi ini melacak variabel reaktif didalam suatu komponen. Ketika nilai dari variable reaktif tersebut diganti/update, maka fungsi dijalankan kembali atau dirender ulang.
