...
Selamat! _Error menjadi sebuah jawaban_. Itu artinya, `mergeByOwner` tidak diizinkan untuk merge branch ke master, yang boleh hanya owner. Jadi sekarang penulis kode sudah fixing code tersebut di production :)
