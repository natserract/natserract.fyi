...
Setiap ada eager, tentu ada lazy (_setiap ada dia, belum tentu ada kamu_). Oke, lazy? mungkin salah satu yang terkenal menggunakan implementasi lazy yaitu [GHC Haskell](https://www.haskell.org/ghc/) ~ functional lazy language
